      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-lg font-semibold text-gray-700 dark:text-gray-300">Loading Wallets...</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Fetching wallet data</p>
          </div>
        </div>
      </div>
    </div>
